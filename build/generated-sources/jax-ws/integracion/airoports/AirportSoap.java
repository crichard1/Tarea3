...
public interface AirportSoap {
    ...
    @RequestWrapper(localName = "getAirportInformationByISOCountryCode", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByISOCountryCode")
    @ResponseWrapper(localName = "getAirportInformationByISOCountryCodeResponse", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByISOCountryCodeResponse")
    ...
    @RequestWrapper(localName = "getAirportInformationByCityOrAirportName", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByCityOrAirportName")
    @ResponseWrapper(localName = "getAirportInformationByCityOrAirportNameResponse", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByCityOrAirportNameResponse")
    ...
    @RequestWrapper(localName = "GetAirportInformationByCountry", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByCountry")
    @ResponseWrapper(localName = "GetAirportInformationByCountryResponse", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByCountryResponse")
    ...
    @RequestWrapper(localName = "getAirportInformationByAirportCode", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByAirportCode")
    @ResponseWrapper(localName = "getAirportInformationByAirportCodeResponse", targetNamespace = "http://www.webserviceX.NET", className = "integracion.airoports.GetAirportInformationByAirportCodeResponse")
